...
export { DocSlidePanel } from "./doc-slide-panel";
export { DocInlineEditor } from "./doc-inline-editor";
...
export { DocList as NoteList } from "./doc-list";
export { DocSlidePanel as DocEditor } from "./doc-slide-panel";
export { NewDocModal as NewNoteModal } from "./new-doc-modal";
