...
/**
 * SlidePanel - A slide-in panel container with fullscreen support
 *
 * Use this for overlay panels that slide in from the right side.
 * Supports expanding to fullscreen mode.
 *
 * Animation flow:
